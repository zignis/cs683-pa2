...
extern uint64_t cycle_at_mispred_instr, total_branch_resolution_latency, branch_resolution_count;
...
class O3_CPU {
  public:
    ...
    uint64_t total_rob_occupancy_at_branch_mispredict, reg_RAW_dependents;
